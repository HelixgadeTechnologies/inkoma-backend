  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center space-y-4 py-4">
        <div className="w-16 h-16 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20 flex items-center justify-center text-[#D4AF37]">
        ...
        <div className="w-full space-y-3 pt-4">
          <Link href="/onboarding" className="w-full block">
            <Button className="w-full bg-[#D4AF37] hover:bg-[#B89628] text-stone-950 font-bold py-5">
        ...
        <p className="text-xs text-stone-500 pt-2">
          Wrong email address?{" "}
          <Link href="/signup" className="text-[#D4AF37] font-semibold underline underline-offset-4">
            Sign up again
          </Link>
        </p>
      </div>
