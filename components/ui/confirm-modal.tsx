...
export function ConfirmModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md w-full p-6 sm:p-7 space-y-5 rounded-3xl border border-stone-200 shadow-2xl bg-white">
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-stone-100">
          ...
          <Button
            ...
            className={`rounded-xl text-xs font-bold px-5 shadow-sm ${
              variant === "danger"
                ? "bg-[#680C07] hover:bg-[#520905] text-white"
